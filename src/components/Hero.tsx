export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-[5%] pt-[140px] pb-20 relative overflow-hidden bg-navy" id="hero">
      ...
      <div className="relative z-10 max-w-[820px]">
        ...
        <h1 className="font-heading text-[clamp(2.5rem,6vw,4.5rem)] font-extrabold text-white leading-[1.05] tracking-tight mb-6 animate-fadeInUp [animation-delay:0.1s]">
          Stop Rewriting Emails.<br />Start <em className="not-italic text-gold">Refining</em> Them.
        </h1>
        <p className="text-[clamp(1rem,2vw,1.2rem)] font-normal text-white/90 leading-relaxed max-w-[580px] mx-auto mb-10 animate-fadeInUp [animation-delay:0.2s]">
        ...
        <div className="flex gap-3.5 justify-center flex-wrap mb-[52px] animate-fadeInUp [animation-delay:0.3s]">
        ...
        <div className="flex items-center justify-center gap-7 flex-wrap animate-fadeInUp [animation-delay:0.4s]">
      ...
      <div className="relative z-10 mt-16 animate-fadeInUp [animation-delay:0.5s] w-full max-w-[860px] max-md:hidden">
        <div className="bg-[#1e1e2e] rounded-2xl overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.08)]">
          ...
          <div className="grid grid-cols-[1fr_320px] min-h-[340px] max-lg:grid-cols-1">
            ...
            <div className="bg-linear-to-b from-navy-4 to-[#0a1e31] p-5 text-white max-lg:hidden">
